return class {
	...
	set style(_value) {
		var _style = this.properties.style;

		for(var v in _style) delete _style[v]
		Object.assign(_style, _value);
	}

	set attributes(_value) {
		var _attributes = this.properties.attributes;

		for(var v in _attributes) delete _attributes[v]
